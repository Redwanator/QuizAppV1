namespace QuizAppV1.Common;

internal static class Messages
{
    public const string SelectDiscipline = "Veuillez sélectionner une discipline avant de commencer le quiz.";
    public const string GoodAnswer = "Bonne réponse !";
